 ...
 */
const getFitsOnTop = (rect: IRect, viewportOffset: number): boolean => {
 ...
 */
const getFitsOnLeft = (rect: IRect, viewportOffset: number): boolean => {
